...
PlayerEditState::PlayerEditState(Game * game) : State(game)
{
    ...
    _statsStrenghtLabel = new TextArea(_t(306,"text/english/game/stat.msg"), 103,46);   
    ...
    _statsPerceptionLabel = new TextArea(_t(307,"text/english/game/stat.msg"), 103,46 + 33);   
    ...
    _statsEnduranceLabel = new TextArea(_t(308,"text/english/game/stat.msg"), 103,46 + 33*2);   
    ...
    _statsCharismaLabel = new TextArea(_t(309,"text/english/game/stat.msg"), 103,46 + 33*3);   
    ...
    _statsIntelligenceLabel = new TextArea(_t(310,"text/english/game/stat.msg"), 103,46 + 33*4);   
    ...
    _statsAgilityLabel = new TextArea(_t(304,"text/english/game/stat.msg"), 103,46 + 33*5);   
    ...
    _statsLuckLabel = new TextArea(_t(305,"text/english/game/stat.msg"), 103,46 + 33*6);   
