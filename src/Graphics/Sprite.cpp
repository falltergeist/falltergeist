...
void Sprite::render(int x, int y, unsigned int width, unsigned int height)
{
    ...
    GL_CHECK(ResourceManager::getInstance()->shader("default")->setUniform("tex",0));

    GL_CHECK(ResourceManager::getInstance()->shader("default")->setUniform("MVP",
    ...
    GL_CHECK(glVertexAttribPointer(ResourceManager::getInstance()->shader("default")->getAttrib("TexCoord"), 2, GL_FLOAT, GL_FALSE, 0, (void*)0 ));
    ...
    GL_CHECK(glEnableVertexAttribArray(ResourceManager::getInstance()->shader("default")->getAttrib("TexCoord")));
    ...
    GL_CHECK(glDisableVertexAttribArray(ResourceManager::getInstance()->shader("default")->getAttrib("TexCoord")));
