...
namespace Falltergeist
{
    namespace Game
    {
        ...
        #define WEAPON_PISTOL           5
        #define WEAPON_SMALL_GUN        6
        #define WEAPON_RIFLE            7
        #define WEAPON_BIG_GUN          8
        #define WEAPON_MINIGUN          9
        #define WEAPON_ROCKET_LAUNCHER 10


        #define PID_POWERED_ARMOR  0x00000003
        #define PID_SPEAR          0x00000007
        #define PID_MINIGUN        0x0000000C
        #define PID_COMBAT_ARMOR   0x00000011
        #define PID_LEATHER_JACKET 0x0000004A
        #define PID_PURPLE_ROBE    0x00000071
    }
}
