...
void PlayerEditName::init()
{
    ...
    auto nameBox = std::make_shared<UI::Image>("art/intrface/namebox.frm");
    nameBox->setX(bgX+35);
    nameBox->setY(bgY+10);
