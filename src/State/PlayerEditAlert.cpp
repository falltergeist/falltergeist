...
void PlayerEditAlert::init()
{
    ...
    auto bg = std::make_shared<UI::Image>("art/intrface/lgdialog.frm");
    ...
    auto message = std::make_shared<UI::TextArea>(_message.c_str(), bgX+194, bgY+213);
    ...
    auto doneButton = std::make_shared<UI::ImageButton>(UI::ImageButton::Type::SMALL_RED_CIRCLE, bgX+264, bgY+273);
