...
SaveGameState::SaveGameState() : State()
{
}
...
void SaveGameState::init()
{
    ...
    // SAVE GAME LABEL
    auto saveGameLabel = new TextArea(msgLoadSave->message(109), bgX+48, bgY+27);
...
void SaveGameState::onDoneButtonClick(std::shared_ptr<MouseEvent> event)
{
    Game::getInstance()->popState();
}

void SaveGameState::onCancelButtonClick(std::shared_ptr<MouseEvent> event)
{
    Game::getInstance()->popState();
}
