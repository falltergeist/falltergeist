...
void LoadGameState::init()
{
    ...
    doneButton->addEventHandler("mouseleftclick", this, (EventRecieverMethod) &LoadGameState::onDoneButtonClick);
    addUI(doneButton);

    // button: Cancel
    auto cancelButton = new ImageButton(ImageButton::TYPE_SMALL_RED_CIRCLE, bgX+495, bgY+349);
    cancelButton->addEventHandler("mouseleftclick", this, (EventRecieverMethod) &LoadGameState::onCancelButtonClick);
    addUI(cancelButton);
