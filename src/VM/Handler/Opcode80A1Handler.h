...
#ifndef FALLTERGEIST_VM_HANDLER_OPCODE80A1_H
#define FALLTERGEIST_VM_HANDLER_OPCODE80A1_H
...
namespace Falltergeist {
    namespace VM {
        namespace Handler {
            class Opcode80A1 : public OpcodeHandler, public virtual IFalloutOpcode {
            public:
